...
const SharedRecordsTab = ({ doctorId, patientId }) => {
    ...
    const filteredRecords = useMemo(() => {
        return sharedRecords.filter((share) => {
            ...
            return share.patientId === patientId;
        });
    }, [sharedRecords, patientId]);
    ...
    if (filteredRecords.length === 0) {
        return (
            <div className="text-center py-5">
                ...
                <h5 className="text-secondary mb-2">No Shared Records from This Patient</h5>
                <p className="text-muted mb-0">This patient has not shared any health records with you.</p>
            </div>
        );
    }
